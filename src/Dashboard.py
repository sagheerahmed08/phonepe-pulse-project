...
Aggre_user = pd.DataFrame(table3,columns = ("States", "Years", "Quarter","Brand", "Transaction_count", "Transaction_Percentage"))
...
cursor.execute("select * from top_district")
connection.commit()
table10 = cursor.fetchall()
Top_district = pd.DataFrame(table10, columns = ("States", "Years", "Quarter", "District", "Transaction_count","Transaction_amount"))
